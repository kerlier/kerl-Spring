package com.fashion.spring.redis.queue;
...
public class RedisLockDefinitionHolder {
    ...
    public RedisLockDefinitionHolder(String businessKey, Long lockTime, Long lastModifyTime,
                                     Thread currentTread, int tryCount) {
